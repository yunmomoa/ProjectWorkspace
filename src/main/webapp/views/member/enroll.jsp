...
<head>
    ...
    <link rel="stylesheet" href="/semi/resources/css/enroll.css">
</head>
            ...
            <div class="form-section">
             ...
             <div class="form-group" style="position: relative;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" id="phone" placeholder="- 없이 숫자만 입력하세요 (예: 01012345678)">
                </div>
